...
$query = "INSERT INTO property (
    ...
    country, state, city, street, land_size, description, facility,
    created_at, gallery, features, views, publish
) VALUES (
    '$username', '$title', 'Land', '$listingType', $price, 'Available',
    '$country', '$state', '$city', '$street',
    '$landSize', '$description', '$facility',
    ...
    if (mysqli_query($db, $query)) {
        echo "Success: Property uploaded";
    } else {
