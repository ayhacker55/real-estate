...
?>
 ...
 <h2 class="mb-4">Property</h2>
  ...
  <label for="conditionSale">Condition:</label>
    <select id="conditionSale" name="condition" class="form-control" required>
    ...
    <select id="furnishedSale" name="furnished" class="form-control" required>
