...
<div class="dashboard">
  <div id="sidebar" class="sidebar">
    <div>
      ...
      <a href="expired.php"><button onclick="showTab('home')">🏠 Home</button></a>
      <a href="expired.php"><button onclick="showTab('subscription')">💳 Subscription</button></a>
  ...
  <div class="main">
    ...
    <div id="addPropertyView" class="blur-overlay">
      <div class="blur-box">
        <?php 
          $plan = $_GET['plan'];
          $name = $_GET['name'];
        ...
        <h3><?php echo "$name Plan <hr>Pay".number_format($amount) ?><span id="propertyType"></span></h3>
    ...
    <script>
        function payWithPaystack() {
            var handler = PaystackPop.setup({
                key: 'pk_test_490358dd29fb9371de1b69218e241fd0ec17394a', // Replace with your Paystack public key
                email: 'customer@email.com', // Customer email
                amount: $amount * 100, // Amount in kobo (i.e. ₦5000 = 500000 kobo)
                currency: 'NGN', // Or 'USD' if international payments are enabled
                ...
                callback: function(response) {
                    ...
                    window.location='success.php?plan=$plan&name=$name&days=$days'
                }
            });
            handler.openIframe();
        }
