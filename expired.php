...
<div id="subscription" class="content-section" style="display: none;">
  ...
  <div class="subscription-container">
    ...
    <div class="plan-card">
     ...
     <a href="payment.php?plan=plana&name=Monthly&amount=5000&days=30"> <button>Subscribe Now</button></a>
    </div>
    <!-- Plan B (Most Popular) -->
  ...
  <a href="payment.php?plan=planb&name=Quarterly&amount=13000&days=90"> <button>Subscribe Now</button></a>
    </div>
    <!-- Plan C -->
    <div class="plan-card">
      <h3>Plan C – Annual</h3>
      ...
      <a href="payment.php?plan=planc&name=Annual&amount=45000&days=360"> <button>Subscribe Now</button></a>
    </div>
