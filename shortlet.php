...
?>
 ...
 <h2 class="mb-4">Decor</h2>
  ...
  <label for="durationShortlet">Duration (e.g., 3 nights, 1 week):</label>
    <input type="text" id="durationShortlet" class="form-select form-control" name="duration" required />
    ...
    <select id="furnishedShortlet" class="form-select form-control" name="furnished" required>
